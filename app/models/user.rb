class User < ActiveRecord::Base
  ...
  has_many :relationships, foreign_key: "follower_id", dependent: :destroy #this is for followers
  has_many :followed_users, through: :relationships, source: :followed #heart of the following
